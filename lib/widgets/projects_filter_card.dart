...
class ProjectsFilterCard extends StatefulWidget {
  const ProjectsFilterCard({Key? key}) : super(key: key);

  @override
  State<ProjectsFilterCard> createState() => _ProjectsFilterCardState();
}

class _ProjectsFilterCardState extends State<ProjectsFilterCard> {
                ...
                Text('FILTRA', style: TextStyle(fontSize: DeviceInfo.sizeTitle3, fontWeight: FontWeight.bold),),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Provider.of<Projects>(context, listen: false).selectedClient != null ? build_resetButton()
                          : const Center(),
    ...
    return Expanded(
      ...
      child: Container(
        ...
        ElevatedButton(
          onPressed: () {
            setState(() {
              Provider.of<Projects>(context, listen: false).selectedClient = null;
            });
            _refreshProjects();
          },
          child:
  ...
  FutureBuilder<void> build_filterByCustomerButton(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (ctx, snapshot) => Expanded(
        flex: Provider.of<Projects>(context, listen: false).selectedClient != null ? 3 : 4,
        child: Container(
          color: Colors.white,
          child: DropdownButton<String?>(
            ...
            value: Provider.of<Projects>(context, listen: false).selectedClient,
            ...
            onChanged: (String? newValue) {
              //print(newValue);
              setState(() {
                Provider.of<Projects>(context, listen: false).selectedClient = newValue;
              });
              _refreshProjects();
            },
          ),
  ...
  Future<void> _refreshProjects() async {
    Provider.of<Projects>(context, listen: false).selectedClient != null
        ...
        .fetchAndSetProjects(Provider.of<Projects>(context, listen: false).selectedClient!)
        : await Provider.of<Projects>(context, listen: false)
        .fetchAndSetProjects();
  }
